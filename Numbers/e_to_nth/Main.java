...
public class Main {
	...
	public int getUserInput() {
		...
		System.out.println("Please enter a value to round off the value of e");
		System.out.print("> ");
	...
	public static void main(String[] args) {
		...
		System.out.println(String.format("%50s", " ").replaceAll(" ", "-"));
		double rounded = test.roundOff(e.getE(), places);
		System.out.println("The value of e when rounded off to " + places + " places is");
